...
from robodm.loader.vla import RayVLALoader, LoadingMode, SliceConfig, create_trajectory_loader, create_slice_loader
...
class VLADataset:
    ...
    def sample(self, num_samples: int, replace: bool = False) -> List[Dict[str, Any]]:
    ...
    def split(self, *fractions: float, shuffle: bool = True):
        ...
        for ray_ds in ray_datasets:
            ...
            split_dataset.loader = self.loader.__class__.__new__(self.loader.__class__)
    ...
    def filter(self, fn):
        ...
        filtered_dataset.loader = self.loader.__class__.__new__(self.loader.__class__)
    ...
    def map(self, fn, **kwargs):
        ...
        mapped_dataset.loader = self.loader.__class__.__new__(self.loader.__class__)
    ...
    def shuffle(self, seed: Optional[int] = None):
        ...
        shuffled_dataset.loader = self.loader.__class__.__new__(self.loader.__class__)
        shuffled_dataset.loader.dataset = self.loader.dataset.random_shuffle(seed=seed)
