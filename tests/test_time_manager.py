...
class TestTimeManager:
    ...
    def test_create_timestamp_sequence(self):
        ...
        tm = TimeManager(time_unit='ms', enforce_monotonic=False)  # Disable monotonic for predictable sequences
        ...
        timestamps_s = tm2.create_timestamp_sequence(
            start_timestamp=0,
            count=3,
            timestep=1,
            unit='s'
    ...
    def test_timezone_handling(self):
        ...
        base_dt_est = datetime(2023, 1, 1, 7, 0, 0, 
...
class TestTrajectoryTimeIntegration:
    ...
    def test_trajectory_with_time_manager(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            trajectory.add('feature1', 'value1', timestamp=1000, time_unit='ms')
            trajectory.add('feature1', 'value2', timestamp=2000, time_unit='ms')
            trajectory.add('feature1', 'value3', timestamp=1500, time_unit='ms')  # Should be adjusted
    ...
    def test_trajectory_mixed_time_units(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            trajectory.add('sensor1', 1.0, timestamp=1, time_unit='s')      # 1000ms
            trajectory.add('sensor1', 2.0, timestamp=1500, time_unit='ms')  # 1500ms  
            trajectory.add('sensor1', 3.0, timestamp=2000000, time_unit='μs')  # 2000ms
...
class TestTimeManagerEdgeCases:
    ...
    def test_sequence_with_overlap_handling(self):
        ...
        timestamps = tm.create_timestamp_sequence(
            start_timestamp=3000,  # Earlier than current state
            count=3,
            timestep=1000
        )
...
class TestTimeManagerPerformance:
    ...
    def test_large_timestamp_sequence_generation(self):
        ...
        tm = TimeManager(time_unit='ms', enforce_monotonic=False)  # Disable for predictable sequence
